...
public class ListsParser {
    ...
    public List<ListElement> parse(InputStream inputStream) throws IOException {
        Type listType = new TypeToken<List<ListElement>>() {
        }.getType();
        Reader reader = new InputStreamReader(inputStream, WiseConstants.DEFAULT_CHARSET);
        return gson.fromJson(reader, listType);
    }

    public String serialize(List<ListElement> lists) {
